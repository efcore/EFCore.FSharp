...
type MyMigration() =
    ...
    override this.Up(migrationBuilder:MigrationBuilder) =
        ...
        migrationBuilder.AlterColumn<Database>(
            name = \"C1\"
            , table = \"C2\", nullable = false, oldClrType = typedefof<Property>, oldNullable = false) |> ignore

        migrationBuilder.AddColumn<PropertyEntry>(
            name = \"C3\"
            , table = \"T1\", nullable = false) |> ignore
...
"
                ...
                // TODO: assert code above against migrationMetadataCode
