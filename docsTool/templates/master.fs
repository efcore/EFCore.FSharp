            ...
            div [ Class "row" ] [
                ...
                linkColumn
                    ...
                    [ [ footerLink
                      ...
                      [ a [ Href "http://foundation.fsharp.org/"
                            Class "text-white" ] [
                            img [ Class "fsharp-footer-logo mr-2"
            ...
            div [ Class "row" ] [
                div [ Class "col text-center" ] [
                    small [ Class "text-light" ] [
                        ...
                        str (sprintf "%s EFCore.FSharp, All rights reserved" (DateTimeOffset.UtcNow.ToString("yyyy")))
                    ]
                ]
            ]
        ]
...
let masterTemplate (cfg: MasterTemplateConfig) navBar titletext bodyText pageSource =
    html [ Lang "en" ] [
        head [] [
            title [] [
                str (sprintf "%s docs / %s" cfg.ProjectName titletext)
            ]
            meta [ Name "viewport"
            ...
            link [ Href(
                       cfg.SiteBaseUrl
                       |> Uri.simpleCombine (
                           sprintf "/content/toggle-bootstrap-dark.min.css?version=%i" cfg.ReleaseDate.Ticks
                       )
                   )
                   Type "text/css"
                   Rel "stylesheet" ]
            ...
            link [ Href(
                       cfg.SiteBaseUrl
                       |> Uri.simpleCombine (sprintf "/content/style.css?version=%i" cfg.ReleaseDate.Ticks)
                   )
                   Type "text/css"
                   Rel "stylesheet" ]
        ...
        body [] [
            ...
            yield
                script [ Src(
                             cfg.SiteBaseUrl
                             |> Uri.simpleCombine (sprintf "/content/themes.js?version=%i" cfg.ReleaseDate.Ticks)
                         ) ] []
            yield
            ...
            yield
                script [ Src(
                             cfg.SiteBaseUrl
                             |> Uri.simpleCombine (sprintf "/content/tips.js?version=%i" cfg.ReleaseDate.Ticks)
                         ) ] []
            if cfg.IsWatchMode then
                yield
                    script [ Src(
                                 cfg.SiteBaseUrl
                                 |> Uri.simpleCombine (sprintf "/content/hotload.js?version=%i" cfg.ReleaseDate.Ticks)
                             ) ] []
            yield
                script [ Src(
                             cfg.SiteBaseUrl
                             |> Uri.simpleCombine (sprintf "/content/submenu.js?version=%i" cfg.ReleaseDate.Ticks)
                         ) ] []
            yield
                script [ Src(
                             cfg.SiteBaseUrl
                             |> Uri.simpleCombine (sprintf "/content/cleanups.js?version=%i" cfg.ReleaseDate.Ticks)
                         ) ] []
        ]
    ]
