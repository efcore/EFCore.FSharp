...
module FSharpMigrationsGeneratorTest =
    ...
    let missingAnnotationCheck (metadataItem:IMutableAnnotatable) (invalidAnnotations:HashSet<string>) (validAnnotations:IDictionary<string, (obj * string)>) (generationDefault : string) (test: IMutableAnnotatable -> IndentedStringBuilder -> unit) =
    ...
    let ``Test new annotations handled for entity types`` () =
        ...
        missingAnnotationCheck
                ...
                forEntityType
                toTable
                (fun m b -> FSharpSnapshotGenerator.generateEntityTypeAnnotations "modelBuilder" (m :> obj :?> _) b |> ignore)