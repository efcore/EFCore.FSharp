...
module StringBuffer =
    ...
    type StringBufferBuilder() =
        ...
        [<CustomOperation("empty_line_if_true")>]
        member inline __.EmptyLineIfTrue(condition) =
            fun (b: IndentedStringBuilder) ->
                if condition then
                    Printf.kprintf (b.AppendLines >> ignore) ""
                else
                    ()

        [<CustomOperation("auto_generated_tag")>]
        member inline __.AutoGeneratedTag() =
            fun (b: IndentedStringBuilder) -> Printf.kprintf (b.AppendLines >> ignore) "// <auto-generated />"
