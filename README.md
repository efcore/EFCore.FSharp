...
[Enter useful description for EFCore.FSharp]
...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/efcore/EFCore.FSharp/workflows/Build%20main/badge.svg)](https://github.com/efcore/EFCore.FSharp/actions?query=branch%3Amain) |
[![Build History](https://buildstats.info/github/chart/efcore/EFCore.FSharp)](https://github.com/efcore/EFCore.FSharp/actions?query=branch%3Amain) |
...
```
$ tree src/EFCore.FSharp/bin/
src/EFCore.FSharp/bin/
└── Debug
    └── net6.0
        ├── EFCore.FSharp.deps.json
        ├── EFCore.FSharp.dll
        ├── EFCore.FSharp.pdb
        └── EFCore.FSharp.xml
...
git branch -M main
git remote add origin https://github.com/efcore/EFCore.FSharp.git
...
[Unreleased]: https://github.com/efcore/EFCore.FSharp/compare/v0.1.0...HEAD
...
- The [Github Action](https://github.com/efcore/EFCore.FSharp/blob/main/.github/workflows/publish.yml) will handle the new tag:
...
- Set Source for "Build and deployment" on [GitHub Pages](https://github.com/efcore/EFCore.FSharp/settings/pages) to `GitHub Actions`.
- Documentation is auto-deployed via [Github Action](https://github.com/efcore/EFCore.FSharp/blob/main/.github/workflows/fsdocs-gh-pages.yml) to [Your GitHub Page](https://efcore.github.io/EFCore.FSharp/)
